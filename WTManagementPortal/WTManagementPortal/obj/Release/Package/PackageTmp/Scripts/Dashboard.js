    ...
    $(function () {
        ...
        $("#main #gridT > tbody > tr > td:nth-child(1):contains('1')").html("<span class='oi agent-active' data-glyph='media-record'></span><span class='agent-active'>Active</span>");
        $("#main #gridT > tbody > tr > td:nth-child(1):contains('0')").html("<span class='oi agent-unresp' data-glyph='media-record'></span><span class='agent-unresp'>Not Responding</span>");
